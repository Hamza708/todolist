...
CTFrontendBuilder.controller("ControllerMediaQueries",["$scope","$parentScope","$http","$timeout","$interval",function(s,o,e,r,d){s.currentMedia="default",s.initMedia=function(){var e=s.getPageWidth(),t=s.getBreakPointWidth("tablet"),i=s.getBreakPointWidth("phone-landscape"),a=s.getBreakPointWidth("phone-portrait");s.previousBreakPointsValues={"page-width":{page:s.pageSettingsMeta["max-width"],global:s.globalSettings["max-width"]},tablet:s.globalSettings.breakpoints.tablet,"phone-landscape":s.globalSettings.breakpoints["phone-landscape"],"phone-portrait":s.globalSettings.breakpoints["phone-portrait"]},s.mediaList={default:{maxSize:"100%",title:"All devices"},"page-width":{maxSize:e+"px",title:"Page container ("+e+"px) and below"},tablet:{maxSize:t-1+"px",title:"Less than "+t+"px"},"phone-landscape":{maxSize:i-1+"px",title:"Less than "+i+"px"},"phone-portrait":{maxSize:a-1+"px",title:"Less than "+a+"px"}},s.mediaListAbove={default:{minSize:"100%",title:"All devices"},"page-width":{minSize:e+1+"px",title:"Above Page container ("+e+"px)"},tablet:{minSize:t+"px",title:"At or above "+t+"px"},"phone-landscape":{minSize:i+"px",title:"At or above "+i+"px"},"phone-portrait":{minSize:a+"px",title:"At or above "+a+"px"}}},s.setCurrentMedia=function(e,t,i){if(s.getCurrentMedia()!=e){if(s.currentMedia=e,void 0===t||t){var a=s.getMediaPreviewSize(e,i);o.adjustViewport(a),"default"==e?o.hideViewportRuller():o.showViewportRuller()}o.adjustViewportContainer(),o.disableContentEdit(),o.disableSelectable(),o.closeAllTabs(["advancedSettings","componentBrowser"]),s.applyModelOptions(),o.checkTabs(),s.parentScope.activeForEditBgLayer=!1;var n=r(function(){o.scrollToComponent(s.getActiveComponent().attr("id")),d.cancel(n)},0,!1)}},s.getCurrentMedia=function(){return s.currentMedia},s.getMediaTitle=function(e,t,i){return e?"never"==e?"Never":"always"==e?"Always":void 0!==s.mediaListAbove&&!0===t?i&&"page-width"==e?"Page container ("+s.getPageWidth("global")+"px) and above":s.mediaListAbove[e].title:void 0!==s.mediaList?i&&"page-width"==e?"Page container ("+s.getPageWidth("global")+"px) and below":s.mediaList[e].title:"":""},s.getMediaMaxSize=function(e){return void 0!==s.mediaList[e]&&s.mediaList[e].maxSize},s.getMediaMinSize=function(e){return void 0!==s.mediaList[e]&&s.mediaListAbove[e].minSize},s.getMediaPreviewSize=function(e,t){if("default"==e)return"100%";var i=s.sortedMediaList(!1,t);for(var a in i){if(i[a]==e){if(void 0===(e=i[parseInt(a)+1]))return(n=s.getBreakPointWidth("phone-portrait")-1)+"px";if("page-width"==e&&t)var n=parseInt(s.getPageWidth(!0))+1;else var n=parseInt(s.mediaList[e].maxSize)+1;return n+"px"}}},s.getMediaNameBySize=function(e){var t=[];for(var i in s.mediaList)s.mediaList.hasOwnProperty(i)&&e<parseInt(s.mediaList[i].maxSize)&&t.push(i);return 0<t.length?t[t.length-1]:"default"},s.getAllMediaNames=function(e){if("default"==e)return[];var t=[];for(var i in s.mediaList)s.mediaList.hasOwnProperty(i)&&parseInt(s.mediaList[e].maxSize)<parseInt(s.mediaList[i].maxSize)&&t.push(i);return t.push(e),t},s.setMediaParameter=function(e,t,i,a){s.component.options[e].media||(s.component.options[e].media={}),s.component.options[e].media[s.currentMedia]||(s.component.options[e].media[s.currentMedia]={}),s.component.options[e].media[s.currentMedia][a]||(s.component.options[e].media[s.currentMedia][a]={}),s.component.options[e].media[s.currentMedia][a][t]=i},s.isHasMedia=function(e,t){if(null==t&&(t=s.component.active.id),s.isEditing("id")){if("ct_reusable"!=s.component.active.name)return!!(s.component.options[t].media&&s.component.options[t].media[e]&&s.component.options[t].media[e][s.currentState]);var i=s.component.options[t].original.view_id;if(!s.postsData[i])return!1;var a=s.postsData[i].post_tree;return!!s.findMedia(a,e)}return s.isEditing("class")?!!(s.classes[s.currentClass]&&s.classes[s.currentClass].media&&s.classes[s.currentClass].media[e]&&s.classes[s.currentClass].media[e][s.currentState]):s.isEditing("custom-selector")&&!s.isEditing("class")?!!(s.customSelectors[s.selectorToEdit]&&s.customSelectors[s.selectorToEdit].media&&s.customSelectors[s.selectorToEdit].media[e]&&s.customSelectors[s.selectorToEdit].media[e][s.currentState]):void 0},s.isHasMedias=function(){for(var e in s.mediaList)if(s.mediaList.hasOwnProperty(e)){if("default"===e)continue;if(!0===s.isHasMedia(e))return!0}return!1},s.removeComponentMedia=function(e,t){s.cancelDeleteUndo(),s.isEditing("id")&&(null==t&&(t=s.component.active.id),s.component.options[t].media&&s.component.options[t].media[e]&&s.component.options[t].media[e][s.currentState]&&(s.component.options[t].media[e][s.currentState]={},delete s.component.options[t].media[e][s.currentState],s.outputCSSOptions(t),s.applyModelOptions(),s.findComponentItem(s.componentsTree.children,t,s.removeMediaFromTree,e))),s.isEditing("class")&&s.classes[s.currentClass]&&s.classes[s.currentClass].media&&s.classes[s.currentClass].media[e]&&s.classes[s.currentClass].media[e][s.currentState]&&(s.classes[s.currentClass].media[e][s.currentState]={},delete s.classes[s.currentClass].media[e][s.currentState],s.outputCSSOptions(),s.applyModelOptions()),s.unsavedChanges(),s.adjustResizeBox()},s.removeMediaFromTree=function(e,t,i){delete t.options.media[i]},s.sortedMediaList=function(e,t){if(!0===e){var i=s.mediaListAbove;size="minSize"}else{i=s.mediaList;size="maxSize"}var a=["default"],n=!1;if(i)if(!0===t)var o=s.globalSettings["max-width"];else o=i["page-width"][size];for(var r in i)if(i.hasOwnProperty(r)){if("default"==r||"page-width"==r)continue;parseInt(i[r][size])>=parseInt(o)||n?a.push(r):(a.push("page-width"),a.push(r),n=!0)}return n||a.push("page-width"),a}}]);
