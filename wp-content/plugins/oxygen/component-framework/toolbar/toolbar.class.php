...
//		} 
	...
	static function element_presets_controls() { 
		...
		// get all elements with presets enabled
		$elements = apply_filters('oxygen_elements_with_presets_list', array());
		$elements = array_map(function($value) {
			return "(isActiveName('$value')&&!hasOpenTabs('$value'))";
		}, $elements);
		$ng_show = implode("||", $elements);

		?>  <div class="oxygen-sidebar-flex-panel oxygen-element-presets-controls oxygen-inset-controls" 
	            ...
	            <div class='oxygen-control-row'>
	                <div class='oxygen-control-wrapper'>
	                    <div class='oxygen-control'>
	                        <div class="oxygen-apply-button"
	                            ng-click="iframeScope.clearCurrentElementStyles()">
	                            <?php _e("Clear Current Styles","oxygen"); ?>
	                        </div>
	                    </div>
	                </div>
	            </div>
